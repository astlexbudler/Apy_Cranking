...
export const NaverIcon = forwardRef((props, ref) => {
  const { sx, ...other } = props;
  const naverImageAsset = `${CONFIG.assetsDir}/assets/images/auth/naver.png`;

  return (
    <IconButton
      ref={ref}
      onClick={() => alert('SNS 로그인 연결이 필요합니다.')}
      sx={[
        {
          p: 0,
          width: 30,
      ...
      {...other}
    >
      <ButtonImage alt="Naver" src={naverImageAsset} />
    </IconButton>
  );
});
...
export const KakaoIcon = forwardRef((props, ref) => {
  const { sx, ...other } = props;
  const kakaoImageAsset = `${CONFIG.assetsDir}/assets/images/auth/kakao.png`;
  ...
  return (
    <IconButton
      ...
      {...other}
    >
      <ButtonImage alt="Kakao" src={kakaoImageAsset} />
    </IconButton>
  );
});
...
export const AppleIcon = forwardRef((props, ref) => {
  const { sx, ...other } = props;
  const appleImageAsset = `${CONFIG.assetsDir}/assets/images/auth/apple.png`;
  ...
  return (
    <IconButton
      ...
      {...other}
    >
      <ButtonImage alt="Apple" src={appleImageAsset} />
    </IconButton>
  );
});
