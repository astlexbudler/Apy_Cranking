...
import { PostCardList } from 'src/sections/component/post-card-list';

// 게시글 검색 메인 섹션
// ----------------------------------------------------------------------
export function SearchEventView({ posts }) {
        ...
        description={
          <Box sx={{ display: 'flex' }}>
            ...
            <Button
              ...
              sx={{ ml: 'auto', gap: 1 }}
            >
              <i className="fi fi-rr-edit" /> 이벤트 작성
            </Button>
          </Box>
        }
      />

      <PostCardList posts={posts} sx={{ mb: 5 }} />
