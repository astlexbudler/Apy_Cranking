...
export const paths = {
  ...
  */
  ...
  notices: '/notices', // 공지사항 페이지
  events: '/events', // 이벤트 페이지
  post: '/post', // 게시글 페이지
  chat: '/chat', // 채팅 페이지
  map: '/map', // 지도 페이지
  ...
  */
  partner: {
    ...
    estimates: '/partner/estimates', // 견적서 페이지
    estimateWrite: '/partner/estimate-write', // 견적서 작성 페이지
  },
  ...
  */
  superuser: {
    ...
    cars: '/superuser/cars', // 차량 관리 페이지
    logs: '/superuser/logs', // 서버 로그 페이지
    settings: '/superuser/settings', // 관리자 설정 페이지
  },
