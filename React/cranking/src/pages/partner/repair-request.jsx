...
import { DetailRepairRequestView } from 'src/sections/view/repair-request/detail-repair-request-view';
...
export default function Page() {
  ...
  return (
    <>
      ...
      <DetailRepairRequestView order={order} estimates={estimates} />
    </>
  );
}
